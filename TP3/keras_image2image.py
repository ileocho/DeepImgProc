...
from random_image_generator import DeadLeavesWithSegm
...
#    def __init__(self, image_aug=None, dim_ordering=K.common.image_dim_ordering()):
...
#    def __init__(self, x_size, y_size, rog_list, noise=None, background_val=0, shuffle=False, dim_ordering=K.common.image_dim_ordering(), image_augm=None, norm=255):
    def __init__(self, x_size, y_size, rog_list, noise=None, background_val=0, shuffle=False, dim_ordering=K.image_data_format(), image_augm=None, norm=255):
